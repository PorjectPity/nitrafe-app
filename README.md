...
![Version](https://img.shields.io/badge/version-1.0.3--stable-blue.svg?style=for-the-badge)
...
| :--- | :--- | :--- | :---: | :---: |
| 🚀 **Executable Setup (Recommended)** | `Nitrafe One_1.0.3_x64-setup.exe` | [⬇️ **Download Setup (.exe)**](./Nitrafe%20One_1.0.3_x64-setup.exe?raw=true) | `.exe` | **~2.7 MB** |
| 📦 **Windows Installer Package** | `Nitrafe One_1.0.3_x64_en-US.msi` | [⬇️ **Download Package (.msi)**](./Nitrafe%20One_1.0.3_x64_en-US.msi?raw=true) | `.msi` | **~4.0 MB** |
...
1. Download [`Nitrafe One_1.0.0_x64-setup.exe`](./Nitrafe%20One_1.0.0_x64-setup.exe?raw=true).
...
```powershell
msiexec /i "Nitrafe One_1.0.3_x64_en-US.msi" /qb
```
...
| :--- | :--- |
| **`Nitrafe One_1.0.3_x64-setup.exe`** | `FA9E6A3E822856462557A1E706BC15C235202BF3024D2F73A989ECC1F11F141F` |
| **`Nitrafe One_1.0.3_x64_en-US.msi`** | `9664813339976EC6092A043C9993F0CBF0CFA9BA2C84B0218B8D86F51A754D05` |

### Verification Command (PowerShell):
```powershell
Get-FileHash "Nitrafe One_1.0.3_x64-setup.exe"
```
